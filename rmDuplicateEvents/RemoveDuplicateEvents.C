...
int RemoveDuplicateEvents(){// string inputfile, string outputfile) {
  ...
  string inputfile = "/publicfs/cms/user/wangzebing/ALP/NTuples/17/data/ntuple_data17.root";
  string outputfile = "/publicfs/cms/user/wangzebing/ALP/NTuples/17/data/ntuple_data17_ramRM.root";
  //create output file
