...
ggh_16_13TeV_cat0 = RooDataSet("ggh_16_13TeV_cat0","ggh_16_13TeV_cat0", ArgSet, "CMS_hza_weight")
#ggh_16_13TeV_cat0_WithoutWeight = RooDataSet("ggh_16_13TeV_cat0_WithoutWeight","ggh_16_13TeV_cat0_WithoutWeight", ArgSet)

ggh_16_13TeV_cat0.Print("v")
#ggh_16_13TeV_cat0_WithoutWeight.Print("v")
print type(ArgSet)
print "#"*51
...
for jentry in range(entries):
    ...
    ggh_16_13TeV_cat0.add(ArgSet,mychain.factor)
    #ggh_16_13TeV_cat0_WithoutWeight.add(ArgSet)

c1 = TCanvas("c1","With Weight")
massDist = CMS_hza_mass.frame(RooFit.Title("CMS_hza_mss"))
ggh_16_13TeV_cat0.plotOn(massDist)
massDist.Draw()
'''
c2 = TCanvas("c2","Without Weight")
massDist2 = CMS_hza_mass.frame(RooFit.Title("CMS_hza_mss"))
ggh_16_13TeV_cat0_WithoutWeight.plotOn(massDist2)
massDist2.Draw()
'''
getattr(w,'import')(ggh_16_13TeV_cat0)
#getattr(w,'import')(ggh_16_13TeV_cat0_WithoutWeight)

w.writeToFile("ALP_data_sig_m16_workspace.root")
