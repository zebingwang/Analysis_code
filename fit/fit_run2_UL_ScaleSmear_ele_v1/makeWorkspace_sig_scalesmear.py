...
for year in ['16', '16APV','17','18']:
    ...
    lepsmear_factor = RooRealVar("lepsmear_factor","lepsmear_factor",1,-10.,10.)
    ...
    getattr(w,'import')(lepsmear_factor)
    ...
    ArgSet_lepsmear = RooArgSet("lepsmear")
    ArgSet_lepsmear.add(lepsmear_factor)
    ...
    for sys in sysList:
        ...
        dataset_lepsmear = RooDataSet("ggh_{0}_13TeV_cat0_lepsmear_{1}".format(mass_H,sys),"ggh_{0}_13TeV_cat0_lepsmear_{1}".format(mass_H,sys), ArgSet_lepsmear, "CMS_hza_weight")
        ...
        for jentry in range(entries):
            ...
            lepsmear_factor.setVal(lep1_f)
            lepsmear_factor.setVal(lep2_f)
            dataset_lepsmear
