...
mvaCuts = {5:0.96, 15:0.96, 30:0.965}
mvaCut = mvaCuts[mass]
model = pickle.load(open(BDT_filename, 'rb'))

####################
filename = '/publicfs/cms/user/wangzebing/ALP/Analysis_out/16/massInde/ALP_M{0}.root'.format(mass)
...
for mass_H in [125 - shift, 125, 125 + shift]:
    ...
    IntLumi = RooRealVar("IntLumi","IntLumi",35.9)
