...
BDT_filename="/publicfs/cms/user/wangzebing/ALP/Analysis_code/MVA/weight/UL/model_ALP_BDT_param_v2.pkl"
mvaCuts = {1:0.96, 2:0.98, 3:0.955, 4:0.985, 5:0.985, 6:0.985, 7:0.99, 8:0.99, 9:0.99, 10:0.99, 15:0.99, 20:0.99, 25:0.985, 30:0.98}
...
for year in ['16', '16APV','17','18']:
    ...
    filename = '/publicfs/cms/user/wangzebing/ALP/Analysis_out/UL_v1/'+year+'/ALP_M{0}.root'.format(mass)
    ...
    for mass_H in [125 - shift, 125, 125 + shift]:
        ...
        for jentry in range(entries):
            ...
            MVA_list = [mychain.pho1Pt, mychain.pho1R9, mychain.pho1IetaIeta55, mychain.pho1PIso_noCorr ,mychain.pho2Pt, mychain.pho2R9, mychain.pho2IetaIeta55,mychain.pho2PIso_noCorr,mychain.ALP_calculatedPhotonIso, mychain.var_dR_Za, mychain.var_dR_g1g2, mychain.var_dR_g1Z, mychain.var_PtaOverMh, mychain.H_pt, mychain.l1_pt, mychain.l2_pt, mychain.Z_m, param]
