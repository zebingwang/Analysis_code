...
#BDT_filename="/publicfs/cms/user/wangzebing/ALP/Analysis_code/MVA/weight/UL/model_ALP_BDT_param_M30.pkl"
if args.interp:
    ...
    mvaCuts = {1:0.955, 2:0.98, 3:0.985, 4:0.98, 5:0.985, 6:0.99, 7:0.985, 8:0.99, 9:0.99, 10:0.99, 15:0.99, 20:0.99, 25:0.985, 30:0.965}
...
CMS_hza_mass = RooRealVar("CMS_hza_mass","CMS_hza_mass",125.,110.,180.)#bing
CMS_hza_weight = RooRealVar("CMS_hza_weight","CMS_hza_weight",-100000.0,1000000.0)
...
data_weight_cat0 = RooDataSet("data_weight_cat0","data_weight_cat0",RooArgSet(CMS_hza_weight))
...
for jentry in range(entries):
    ...
    data_weight_cat0.add(RooArgSet(CMS_hza_weight))


c1 = TCanvas("c1")
massDist = CMS_hza_mass.frame(RooFit.Title("CMS_hza_mss"))
data_weight_cat0.plotOn(massDist)
massDist.Draw()

#getattr(w,'import')(data_mass_cat0)
getattr(w,'import')(data_mass_cat0)
getattr(w,'import')(data_weight_cat0)


w.writeToFile("ALP_DY_Am{0}_workspace.root".format(mass))
del w
