    ...
    for sys in sysList:
        ...
        for jentry in range(entries):
            ...
            if sys in pho1_corrE.keys():
                ...
                lep1_f = lep1_corrE[sys]/mychain.l1_EPostCorr
                lep2_f = lep2_corrE[sys]/mychain.l2_EPostCorr
                
                lep1_corr.SetPxPyPzE(lep1.Px()*lep1_f, lep1.Py()*lep1_f, lep1.Pz()*lep1_f, lep1_f*lep1.E())
                lep2_corr.SetPxPyPzE(lep2.Px()*lep2_f, lep2.Py()*lep2_f, lep2.Pz()*lep2_f, lep2_f*lep2.E())
                
                H_m = (pho1+pho2+lep1_corr+lep2_corr).M()
                #print lep1_f, lep2_f, lep1_corrE[sys]/lep1.E(), H_m/mychain.H_m, H_m
            else:
                H_m = mychain.H_m
